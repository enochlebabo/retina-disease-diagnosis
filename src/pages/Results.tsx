        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-blue-100 text-sm">Overall Accuracy</p>
                <p className="text-3xl font-bold">95.1%</p>
                <p className="text-blue-100 text-sm mt-1">+1.3% this month</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <AreaChart data={weeklyTrends}>
                ...
                <Tooltip />
                <Area yAxisId="left" type="monotone" dataKey="scans" stackId="1" stroke="#3b82f6" fill="#3b82f6" fillOpacity={0.6} />
